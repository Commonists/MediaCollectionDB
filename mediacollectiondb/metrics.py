...
class MediaCollectionsMetrics(object):
    ...
    def widthcount(self, width):
        """Return the amount of pictures with a wider border greater than the minimal width.
    ...
    def qualitypixelcount(self):
        """Return the total amount of pixels from quality images in all media collections."""
